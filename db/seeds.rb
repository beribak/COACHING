...
lesson1 = Lesson.create!( user: user1, category: category1, title: "English / beginner", description: "I have been teaching English for more then 7 years now, working with all ages, from kids to elderly. I would love to help those newcomers who fled wars and conflicts to save their lives and ended up in Netherlands. I have a small office space that can fit 10 people, that will serve as a setting for our classes.", places: 6, start_date: "2022-05-04", end_date: "2022-06-04", address: "Bloemstraat, Amsterdam")
