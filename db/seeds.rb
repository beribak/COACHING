...
lesson4 = Lesson.create!( user: user1, category: category1, title: "English / advanced", description: "I have been teaching engish for more then 7 yers now, teaching all sorts of ages, from kids to elderly. I would love to help those newcomers who form from wars and conflict to save their lives and ended up i. I have a small office space that can fit 10 people, that will serve as a setting for our classes.", places: 10, start_date: "2022-07-11", end_date: "2022-11-11", address: "Bloemstraat, Amsterdam")
